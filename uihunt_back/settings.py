"""
Django settings for uihunt_back project.
...
SECRET_KEY = 'xcyqa__zq@)7by(00)q(-xxo23+opm2jbqlvvu%*+52g@cm)68'
...
WSGI_APPLICATION = 'uihunt_back.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = 'uihunt'
